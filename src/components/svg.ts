...
export default class Svg {
  ...
  private readonly svg: d3selection.Selection<
    SVGSVGElement,
    undefined,
  ...
  public transformSelection = (): d3selection.Selection<
    SVGSVGElement,
    undefined,
    d3selection.BaseType,
    undefined
  ...
  public initDisplay() {
    this.resetViewBox();
    this.svg.attr("style", "").call(this.zoom);
    this.resizeHandler();
  ...
  private resizeHandler = () => {
    ...
    this.svg.attr("width", clientRect.width).attr("height", clientRect.height);
  };
