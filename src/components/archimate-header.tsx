        ...
        return (
            <nav className="navbar navbar-default" style={navbarMargin}>
                <div className="container-fluid">
                    <div className="navbar-header col-md-4" style={{overflow: "hidden"}}>
                        <a id="archimate-diagram-title" className="navbar-brand archimate-diagram-header" href="#">
                            {this.props.name} &nbsp;
                            <small>{this.props.viewpoint}</small>
                        </a>
                    </div>
                    <div className="collapse navbar-collapse">
                        <ul className="nav nav-tabs" style={{display: "inline-block", marginTop: "3px"}}>
                            <li
                                role="presentation"
                                className={this.props.viewKey === ActiveView.Diagram ? "active" : undefined}
                            >
                                <a onClick={this.diagramSelected} >
                                    Diagram
                                </a>
                            </li>
                            <li
                                role="presentation"
                                className={this.props.viewKey === ActiveView.Graph ? "active" : undefined}
                            >
                                <a onClick={this.graphSelected} >Graph</a>
                            </li>
                            <li
                                role="presentation"
                                className={this.props.viewKey === ActiveView.Table ? "active" : undefined}
                            >
                                <a onClick={this.tableSelected} >Table</a>
                            </li>
                        </ul>
                        <div className="btn-group navbar-right" role="group" aria-label="Diagram Controls">
                            <button
