    ...
    `;
        return (
            <svg ref={(svg) => {this.svg = svg;}} xmlns="http://www.w3.org/2000/svg" version="1.1" width="1000" height="1000" viewBox="0 0 1000 1000">
                ...
                <defs>
                    <symbol id="archimate-rect-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <rect x="1" y="1" width="118" height="53" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                    </symbol>

                    <symbol id="archimate-rounded-rect-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <rect x="1" y="1" width="118" height="53" rx="5" ry="5" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                    </symbol>

                    <symbol id="archimate-component-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <rect x="10" y="1" width="108" height="53" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                        <rect x="1" y="11" width="21" height="13" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                        <rect x="1" y="11" width="21" height="13" className="archimate-decoration"/>
                        <rect x="1" y="31" width="21" height="13" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                        <rect x="1" y="31" width="21" height="13" className="archimate-decoration"/>
                    </symbol>

                    <symbol id="archimate-event-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <path d="M 1 1 l 18 27 l -18 27 h 102.0 a 17 27 0 0 0 0 -54.0 z" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                    </symbol>

                    <symbol id="archimate-product-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <rect x="1" y="1" width="118" height="53" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                        <rect x="1" y="1" width="60" height="8" className="archimate-decoration"/>
                    </symbol>

                    <symbol id="archimate-object-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <rect x="1" y="1" width="118" height="53" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                        <rect x="1" y="1" width="118" height="8" className="archimate-decoration"/>
                    </symbol>

                    <symbol id="archimate-contract-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <rect x="1" y="1" width="118" height="53" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                        <rect x="1" y="1" width="118" height="8" className="archimate-decoration"/>
                        <rect x="1" y="46" width="118" height="8" className="archimate-decoration"/>
                    </symbol>

                    <symbol id="archimate-service-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <rect x="1" y="1" width="118" height="53" rx="27" ry="27" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                    </symbol>

                    <symbol id="archimate-value-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <ellipse cx="60" cy="27.5" rx="59.0" ry="26.5" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                    </symbol>

                    <symbol id="archimate-representation-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <path d="M 1 1 v 47 c 20 7.315 40.32 7.315 60.96 0 c 1.932 -4.279 38.64 -4.279 57.0 0 v -47.0 z" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                    </symbol>

                    <symbol id="archimate-meaning-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <rect x="1" y="1" width="118" height="53" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                    </symbol>

                    <symbol id="archimate-artifact-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <path d="M 1 1 h 100 l 18 18 v 35 h -118 z"/>
                        <path d="M 102 1 v 18 h 18 z" className="archimate-decoration"/>
                    </symbol>

                    <symbol id="archimate-motivation-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <path d="M 11 1 h 98 l 10 10 v 33 l -10 10 h -98 l -10 -10 v -33 z" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                    </symbol>

                    <symbol id="archimate-node-shape" className="archimate-shape" viewBox="0 0 120 55">
                        <path d="M 1 54 v -46 l 7 -7 h 111 v 46 l -7 7 z" style={{fill:"inherit",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                        <path d="M 1 8 l 7 -7 h 111 v 46 l -7 7 v -46 z M 119 1 l -7 7" className="archimate-decoration"/>
                        <path d="M 1 8 h 111 l 7 -7 M 112 54 v -46" style={{fill:"none",stroke:"inherit"}}/>
                    </symbol>
                    <symbol id="archimate-material-badge" className="archimate-badge" viewBox="0 0 20 20">
                        ...
                        <path style={{fill:"none",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}} d="M 4.5472185,10.333586 8.1220759,4.0990346"/>
                        <path style={{fill:"none",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}} d="m 12.154515,4.0418369 3.51766,6.2917491"/>
                        <path style={{fill:"none",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}} d="m 6.5491386,14.223031 7.0925174,-0.0572"/>
                    </symbol>
                    <symbol id="archimate-distribution-network-badge" className="archimate-badge" viewBox="0 0 20 20">
                        <path style={{fill:"none",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"round",strokeLinejoin:"round"}} d="M 5.8847321,2.5480283 1.4964611,6.7745197 5.7431749,10.596562"/>
                        <path style={{fill:"none",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}} d="m 3.5995956,4.8129424 12.6592514,0"/>
                        <path d="m 3.5995956,8.6754298 13.2861464,0" style={{fill:"none",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter"}}/>
                        <path d="m 14.314928,2.7502528 4.388271,4.2264914 -4.246714,3.8220418" style={{fill:"none",stroke:"inherit",strokeWidth:"1px",strokeLinecap:"round",strokeLinejoin:"round"}}/>
                    </symbol>
                    <symbol id="archimate-facility-badge" className="archimate-badge" viewBox="0 0 20 20">
                        <path style={{fill:"none",stroke:"inherit",strokeWidth:"1px",strokeLinejoin:"miter"}} d="m 2.1449144,17.940882 0,-15.7007732 2.1735133,0 0,10.2383912 4.5472185,-2.7740891 0,2.8598861 4.4900208,-2.888485 0,2.74549 4.51862,-2.6882923 0,8.2078723 z"/>
                    </symbol>
                    <symbol id="archimate-equipment-badge" className="archimate-badge" viewBox="0 0 20 20">
                        <g transform="translate(0,-7)">
                            <circle cx="8" cy="18.7" r="2.432014" style={{fill:"none",stroke:"inherent",strokeWidth:"0.7"}}/>
                            <circle cx="13.7" cy="12.6" r="2.0318091" style={{fill:"none",stroke:"inherent",strokeWidth:"0.7"}}/>
                    ...
                    <symbol id="archimate-communication-badge" className="archimate-badge" viewBox="0 0 20 15">
                    ...
                    <marker id="archimate-dot-marker" viewBox="0 0 10 10" refX="4" refY="4" markerUnits="strokeWidth" markerWidth="8" markerHeight="8">
                    ...
                    <marker id="archimate-filled-diamond" viewBox="0 0 10 10" refX="1" refY="5" markerUnits="strokeWidth" markerWidth="12" markerHeight="12" orient="auto">
                        <polygon points="5,2.5 9,5 5,7.5 1,5" fill="black" stroke="black"/>
                    </marker>
                    <marker id="archimate-hollow-diamond" viewBox="0 0 10 10" refX="1" refY="5" markerUnits="strokeWidth" markerWidth="13" markerHeight="13" orient="auto">
